...
- (NSString *)CT_machineType
{
    ...
    if ([machineType isEqualToString:@"iPhone6,1"] || [machineType isEqualToString:@"iPhone6,2"])   return @"iPhone 5S";
    if ([machineType isEqualToString:@"iPhone7,1"])    return @"iPhone 6 Plus";
    if ([machineType isEqualToString:@"iPhone7,2"])   return @"iPhone 6";
    
    if ([machineType isEqualToString:@"iPhone8,1"])    return @"iPhone 6s Plus";
    if ([machineType isEqualToString:@"iPhone8,2"])   return @"iPhone 6s";
    
    if ([machineType isEqualToString:@"iPhone9,1"])    return @"iPhone 7 Plus";
    if ([machineType isEqualToString:@"iPhone9,2"])   return @"iPhone 7";
